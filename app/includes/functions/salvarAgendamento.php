...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $query = "INSERT INTO agendamentos (cliente_id, pet_id, endereco_id, pacote, observacoes_cliente, status) VALUES (?, ?, ?, ?, ?, ?)";
        ...
        // Inserir serviços
        if (!empty($servicos)) {
            $query = "INSERT INTO agendamento_servico (agendamento_id, servico_id) VALUES (?, ?)";
            $queryExec = $conn->prepare($query);
